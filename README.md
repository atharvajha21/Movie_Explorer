...
```bash
git clone https://github.com/atharvajha21/Movie_Explorer.git
cd Movie_Explorer
open index.html
```
...
| Date | Changes |
|---|---|
| Apr 1 | Added genre/type filter and expanded year filter options |
| Apr 2 | Added watchlist modal with localStorage persistence |
| Apr 3 | Added skeleton loading cards and IMDb rating display |
| Apr 4 | Added pagination and empty state with retry action |
| Apr 5 | Added movie detail modal with full plot, cast, director, IMDb link |
